...
def main(config):
    ...
    comet_logger = WandbLogger(name=config["exp"]["exp_name"], save_dir=os.path.join(logger_dir, config["exp"]["exp_name"]), project="CVPR2023-Fast")
    ...
    trainer.fit(system, ckpt_path="/home/likai/data2/CVPR2023/Experiments/checkpoint/LRS2-2ms-batch=3-8gpus-img84-IMANetIntraGAInterLAInterGA/epoch=140.ckpt")
