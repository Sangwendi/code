...
def main(config):
    ...
    state_dict = torch.load("/apdcephfs/private_jusperli_cq/CVPR2023-all/Experiments/checkpoint/LRS2-21-10-adamw-lr=1e-batch=4-8gpus-tencent-IMANetIntraGAInterLAInterGALessVideoBN/epoch=131.ckpt")
